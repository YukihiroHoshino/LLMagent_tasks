...
• Simultaneously, each Nursery identifies the Parent with the highest priority (based on the Nursery's internal standards) among all Parents. 
• The computer looks for a "closed loop" where applications and identifications match. This occurs in two cases: 
1. A Parent applies to a Nursery, and that Nursery identifies the same Parent. 
2. A chain is formed (e.g., Parent A applies to School X, School X identifies Parent B, and Parent B applies to School Y... eventually leading back to a Nursery that identifies Parent A). 
• Parents involved in such a closed loop are permanently admitted to the Nursery to which they sent their application. 
• The admitted Parents and the corresponding seats at the Nurseries are removed from the procedure.

Step 2 
• For each Parent who was not admitted in the previous step, an application is sent to the Nursery that they ranked highest among the Nurseries that still have quotas. 
• Each Nursery with quotas identifies the Parent with the highest priority among the Parents who have not yet been admitted. 
• As in the previous step, the computer looks for closed loops where applications and identifications match or form a chain. 
• The Parents involved in these loops are permanently admitted to the Nursery they applied to, and they are removed from the procedure together with the filled seats.

Following steps 
• The procedure continues according to the same rules.

Final Step
• The procedure ends when all Parents are admitted or all quotas are filled.
"""
