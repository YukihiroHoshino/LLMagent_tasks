...
End of Part 1
• The procedure in Part 1 ends when no Parent is rejected, that is, each Parent is assigned a seat at a Nursery. At this point, all temporary admissions become final.
"""
