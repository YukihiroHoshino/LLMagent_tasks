...
• Each Nursery considers all applications received. The Parent with the highest priority is **permanently admitted** up to the Nursery's capacity.
• The remaining Parents are rejected.
• Note: Once a Parent is admitted in this step, their match is final. The Nursery is no longer available in subsequent steps.
...
• Importantly, Parents can only apply to Nurseries that still have seats available (i.e., Nurseries that did not fill their position in Step 1).
• Among the new applicants, the available Nurseries permanently admit the Parents with the highest priority. The remaining Parents are rejected.

Following steps
• The procedure continues according to the same rules, with rejected Parents applying to their next ranked Nursery, provided that the Nursery still has a vacancy.

Final Step
• The procedure ends when no Parent is rejected or all rejected Parents have run out of Nurseries on their list.
"""
